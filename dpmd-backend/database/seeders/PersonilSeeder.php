...
class PersonilSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('personil')->insert([
            ...
            ['id_personil' => 7, 'id_bidang' => 1, 'nama_personil' => 'TRI WIDIYARTO S. IP, M. PA'],
            ...
            ['id_personil' => 59, 'id_bidang' => 8, 'nama_personil' => 'Wawan Darmawan'],
            ['id_personil' => 60, 'id_bidang' => 8, 'nama_personil' => 'Suratman'],
            ['id_personil' => 61, 'id_bidang' => 8, 'nama_personil' => 'Adi Hermawan'],
            ['id_personil' => 62, 'id_bidang' => 8, 'nama_personil' => 'Otasi Carles Manalu'],
            ['id_personil' => 63, 'id_bidang' => 8, 'nama_personil' => 'Ahmad Imam Maulana'],
            ['id_personil' => 64, 'id_bidang' => 8, 'nama_personil' => 'Wahyu Ari Sucipto'],
            ['id_personil' => 65, 'id_bidang' => 8, 'nama_personil' => 'Atika Seknun'],
            ['id_personil' => 66, 'id_bidang' => 8, 'nama_personil' => 'Iyah Samsiyah'],
            ['id_personil' => 67, 'id_bidang' => 9, 'nama_personil' => 'Rini'],
            ['id_personil' => 68, 'id_bidang' => 9, 'nama_personil' => 'Erwin Yuniawan Kusuma'],
            ['id_personil' => 69, 'id_bidang' => 9, 'nama_personil' => 'Umar'],
            ['id_personil' => 70, 'id_bidang' => 9, 'nama_personil' => 'Haerudin'],
            ['id_personil' => 71, 'id_bidang' => 9, 'nama_personil' => 'Rizkia Safitri'],
            ['id_personil' => 72, 'id_bidang' => 9, 'nama_personil' => 'Syukur Makmun'],
            ['id_personil' => 73, 'id_bidang' => 9, 'nama_personil' => 'Beni Permana'],
            ['id_personil' => 74, 'id_bidang' => 9, 'nama_personil' => 'Basri Ramadan'],
            ['id_personil' => 75, 'id_bidang' => 7, 'nama_personil' => 'Dian Munandar'],
            ['id_personil' => 76, 'id_bidang' => 7, 'nama_personil' => 'Rachmat Ramadhan S. Ak'],
            ['id_personil' => 77, 'id_bidang' => 7, 'nama_personil' => 'Arfa Cesaria A. Md'],
            ['id_personil' => 78, 'id_bidang' => 7, 'nama_personil' => 'Nina Melinda S.Pd'],
            ['id_personil' => 79, 'id_bidang' => 7, 'nama_personil' => 'Mas Cecep Tino Noviandi A. Md'],
            ['id_personil' => 80, 'id_bidang' => 7, 'nama_personil' => 'Chintia Ainun Fadhilah S.M.'],
            ['id_personil' => 81, 'id_bidang' => 7, 'nama_personil' => 'Rizki Iriani A. Md'],
            ['id_personil' => 82, 'id_bidang' => 7, 'nama_personil' => 'Fariz Andifa S.Kom'],
            ['id_personil' => 83, 'id_bidang' => 7, 'nama_personil' => 'Imam Septiyansyah S. Kom'],
            ['id_personil' => 84, 'id_bidang' => 7, 'nama_personil' => 'Erma Diah Vitaloka S.T.'],
            ['id_personil' => 85, 'id_bidang' => 7, 'nama_personil' => 'Zaenudin S. Pd'],
            ['id_personil' => 86, 'id_bidang' => 7, 'nama_personil' => 'Neneng Muflihah S.E'],
            ['id_personil' => 87, 'id_bidang' => 7, 'nama_personil' => 'Dian Noviani S. IK'],
            ['id_personil' => 88, 'id_bidang' => 7, 'nama_personil' => 'Gema Alifa Eastiana S.I.Kom'],
            ['id_personil' => 89, 'id_bidang' => 7, 'nama_personil' => 'Muhamad Rafli S.E.'],
            ['id_personil' => 90, 'id_bidang' => 7, 'nama_personil' => 'Aulya Ardhi Fauqa S.H.'],
            ['id_personil' => 91, 'id_bidang' => 7, 'nama_personil' => 'Sandra Febri Ramdhiani S.H.'],
            ['id_personil' => 92, 'id_bidang' => 7, 'nama_personil' => 'Muhammad Fahmi S. Kom'],
            ['id_personil' => 93, 'id_bidang' => 7, 'nama_personil' => 'Devin Prasetia Bastian S.P.W.K'],
            ['id_personil' => 94, 'id_bidang' => 7, 'nama_personil' => 'Moch. Rizki Utama S.P.W.K'],
            ['id_personil' => 95, 'id_bidang' => 7, 'nama_personil' => 'Denna S. Dahmar Hidayati S. Ak'],
            ['id_personil' => 96, 'id_bidang' => 7, 'nama_personil' => 'Fahri Setya Gunawan'],
        ]);
    }
}