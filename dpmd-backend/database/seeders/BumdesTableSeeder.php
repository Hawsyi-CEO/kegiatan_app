...
class BumdesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach ($data as $bumdesData) {
            ...
            // Periksa apakah data dengan 'desa' yang sama sudah ada sebelum membuat
            if (Bumdes::where('desa', $mappedData['desa'])->exists()) {
                $this->command->warn("Data untuk desa '{$mappedData['desa']}' sudah ada. Melewatkan pembuatan entri.");
